...
import 'package:loginuicolors/screens/main_screens/contact_us.dart';
import 'package:loginuicolors/screens/main_screens/livemcx.dart';
...
import 'package:loginuicolors/constant/app_info.dart' as app_info;
...
class _MyBottomBarState extends State<MyBottomBar> {
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Colors.white, Color(0xFFFAF0E6), Color(0xFFFFE4E1)],
          ),
        ),
        child: ListView(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [Color(0xFF800000), Color(0xFF5D0000)],
                ),
                boxShadow: [
                  BoxShadow(
            ...
            Theme(
              data: Theme.of(context).copyWith(
                ...
                colorScheme: ColorScheme.light(primary: Color(0xFF800000)),
              ),
              child: ExpansionTile(
                leading: Icon(
              ...
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.favorite, color: Color(0xFF800000), size: 22),
                      SizedBox(width: 10),
                      Text(
                        'Follow Us',
                        style: TextStyle(
  ...
  Widget _buildLanguageOption(String value, String title) {
    return Obx(
      () => Container(
        ...
        decoration: BoxDecoration(
          color:
              languageController.currentLanguage.value == value
  ...
  Widget _getBodyWidget() {
    return Column(children: [Expanded(child: _getSelectedTabContent())]);
  }
  ...
  Widget _getSelectedTabContent() {
    if (_selectedIndex == 0) {
      ...
      return const Center(child: Gallery());
